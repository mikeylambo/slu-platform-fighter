...
const creditedKo = result.events.find((event) => event.type === 'ko' && event.fighterId === 'fighter-b');
...
const expiredKo = result.events.find((event) => event.type === 'ko' && event.fighterId === 'fighter-b');
